...
import android.widget.Spinner;
 ...
 public class MainActivity extends AppCompatActivity {
     ...
     public static Actions value_of_Countries;
     @RequiresApi(api = Build.VERSION_CODES.O)
     @Override
     protected void onCreate(Bundle savedInstanceState) {
         super.onCreate(savedInstanceState);
         setContentView(R.layout.activity_main);
         value_of_Countries = new Actions();
...
//        });
         ...
         bt_game.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View view) {
                 value_of_Countries.setSteps( Integer.parseInt( String.valueOf(spinner.getSelectedItem())));
